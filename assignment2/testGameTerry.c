...
//test 1
static void check_hand(Game game, int player, value values[], color colors[], suit suits[]);
static void check_deck(Game game, int deck_size, value values[], color colors[], suit suits[]);
static void check_discard(Game game, int deck_size, value values[], color colors[], suit suits[]);
